...
import { addcategoryApi, detailsSellApi, editMySellApi } from "../../servieApi/sellApi"
...
const {id}=useParams()
    ...
    const handelclickEditSell = () => {
        ...
        editMySellApi(id,formdata).then((res: any) => {
            alert("Edit successfully")
           navigate(`/detailSell/${id}`)
        }).catch((err: any) => {
            console.log("err=", err)
        })
    }
    ...
    return (
        <div className={classes.container}>
            ...
            <Button onClick={handelclickEditSell} variant="contained">Edit MySell</Button>
